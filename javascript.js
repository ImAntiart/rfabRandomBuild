...
const paths = ["Праведник", "Вестник смерти", "Вампир", "Еретик(Без пути)", "Оборотень"];
...
const toolkit = ["Двуручное оружие", "Крики", "Открытый Лук", "Кулачник",
    ...
    "Восстановление: Яд", "Колдовство: Призванное оружие", "Иллюзия", "Изменение: Боевая магия"];
...
/*   const toolkitColor = {
    "Праведник", "Вестник смерти", "Вампир", "Еретик(Без пути)", "Оборотень"
  }
 */
